...
?>
    ...
    <div class="second-div" >
        ...
        <div class="four-div">
            <h4 class="organization-name">Nome da Organização</h4>
            <h2 class="organization-description">Descrição da Organização</h2>
        </div>
        <div class="dropdown">
            <div class=" d-flex h-auto p-2 mb-3">
                ...
                <img src="../../img/Admin/editar-icon.png" alt="" class="ms-auto me-2" style="width: 45px;">
                    ...
                    <ul class="dropdown-menu text-small">
                        <li>
                            <a class="dropdown-item" href="">Alterar Dados</a></li>
                            <hr class="dropdown-divider">
                        </li>
                            <a class="dropdown-item" href="">Alterar Imagens</a></li>
                        <li>
                    </ul>
            </div>
        </div>
