    ...
    <ul class="nav flex-column menu linha ps-2 pt-5">
      ...
      <div class="collapse" id="collapseAnalise">
        <li class="menuItems w-100 p-1 ps-4">
          <a class="" href="../Análise - Pendente/" style="text-decoration: none; color: #a6a6a6;">
          <img src="../../img/Admin/icon-pendente.png" alt="" id="menu-icon">
            <span>Pendentes</span>
          </a>
        </li>
        <li class="menuItems w-100 p-1 ps-4">
          <a class="" href="../Análise - Concluído/" style="text-decoration: none; color: #a6a6a6;">
          <img src="../../img/Admin/icon-concluido.png" alt="" id="menu-icon">
      ...
      <div class="collapse" id="collapseOrg">
        <li class="menuItems w-100 p-1 ps-4">
          <a class="" href="../Dados Perfil/" style="text-decoration: none; color: #a6a6a6;">
          <img src="../../img/Admin/icon-analise.png" alt="" id="menu-icon">
