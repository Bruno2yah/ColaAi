            ...
            <div class=" col-md-8">
              <div class="row">
                ...
                <div class="col-md-6 mb-3 needs-validation">
                  ...
                  <input type="text" class="form-control inputAdm" placeholder="Digite o seu sobrenome" name="sobrenome" maxlength="50" id="sobrenomeAdmin" value="<?=$cpf_Admin?>" required>
                  <div class="invalid-feedback">
                    Preencha este campo
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6 needs-validation">
                  ...
                  <input type="cpf" class="form-control inputAdm" placeholder="000.000.000-00" data-mask = "000.000.000-00" name="cpfAdmin" maxlength="100" id="cpfAdmin" value="<?=$email_Admin?>" required>
                </div>
                <div class="col-md-6 needs-validation">
