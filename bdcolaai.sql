...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Mar-2024 às 20:27
...
CREATE TABLE `tborganizacaoevento` (
  ...
  `linkSiteOrganizacaEvento` varchar(2000) DEFAULT NULL,
...
--
-- Estrutura da tabela `tbtelorganizacaoevento`
--
...
--
-- Índices para tabela `tbtelorganizacaoevento`
--
...
--
ALTER TABLE `tborganizacaoevento`
  MODIFY `idOrganizacaoEvento` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Limitadores para a tabela `tbtelorganizacaoevento`
--
ALTER TABLE `tbtelorganizacaoevento`
