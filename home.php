    ...
    <div class="cover-container d-flex w-100 h-100 p-3 flex-column mx-auto d-flex justify-content-center d-flex align-items-center">
      ...
      <main class="px-4 row d-flex justify-content-between align-items-center" style="padding-top: 300px">
        <div class="col-md-3 col-sm-3 tituloCover">
          ...
          <p class="lead">
          <p href="#Quemsomos" class="btn btn-lg btn-dark fw-bold border-white bg-orange" style="width: 300px; height: 60px; border-radius: 45px; font-size: 35px; font-family: 'Josefin Sans', sans-serif;">Saiba Mais</p>
          </p>
        </div>
  ...
  <div class="d-flex justify-content-center d-flex align-items-center">
    <div class="cover-2 d-flex w-100 h-100 flex-column mx-auto d-flex justify-content-center d-flex align-items-center">
      ...
      <main class="px-3 p-5">
        ...
        <img src="./img/linhaTempo.png" alt="plataformas" style="width: 1200px; max-width: 100%; height: auto; padding-top:20px">
        <div id="Projetos"></div>
      </main>
          ...
          <div class="col-xs-6 col-sm-6 col-md-6">
            <form class="row">
              <div class="col-6 mb-3">
                <p class="text-start" style="font-size: 30px; font-family: 'Josefin Sans', sans-serif; font-weight: bold;  margin: 0px 0px 0px;">Nome:
                <p>
              ...
              <div class="col-6 mb-3">
                <p class="text-start" style="font-size: 30px; font-family: 'Josefin Sans', sans-serif; font-weight: bold; margin: 0px 0px 0px;">Sobrenome:
                <p>
                  <input type="name" class="form-control" id="exampleFormControlInput1" style="border-width: 3px; border-color: black; border-radius: 15px; height: 5vh; font-size: 20px; box-shadow: 0 8px 12px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
              </div>
              <div class="col-12 mb-3">
                <p class="text-start" style="font-size: 30px; font-family: 'Josefin Sans', sans-serif; font-weight: bold; margin: 0px 0px 0px">Email:
                <p>
