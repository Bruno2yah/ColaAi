  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.text}>
        <Text style={styles.title}>Adicione um banner ao perfil</Text>
        <Text style={styles.description}>
        A imagem ficará visivel aos usuários e administradores do Cola Aí.
        </Text>
      </View>
      {image && <Image source={{ uri: image }} style={styles.image} />}
      {!image && (
        <TouchableOpacity style={styles.imageButton} onPress={pickImage}>
          <Image source={require('../../../../../../../assets/img/adicionarBaner.png')} style={styles.icon} />
        </TouchableOpacity>
      )}
      <View style={styles.buttonColumn}>
        <TouchableOpacity style={styles.button2} onPress={() => navigation.navigate('Descricao')}>
